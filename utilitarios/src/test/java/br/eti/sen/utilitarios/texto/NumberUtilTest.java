...
/*
    ...
    public void inicializarTeste() throws ParseException {
        ...
        dataStr.append(format.parse(Integer.toString(data.getMonthValue())).toString());
        dataStr.append(StringUtil.BARRA);
        ...
        dataHoraStr.append(format.parse(Integer.toString(dataHora.getMonthValue())).toString());
        dataHoraStr.append(StringUtil.BARRA);
        dataHoraStr.append(dataHora.getYear());
        dataHoraStr.append(StringUtil.ESPACO);
        dataHoraStr.append(format.parse(Integer.toString(dataHora.getHour())).toString());
        dataHoraStr.append(':');
        dataHoraStr.append(dataHora.getMinute());
        horaStr = new StringBuilder(format.parse(Integer.toString(hora.getHour())).toString());
        horaStr.append(':');
        horaStr.append(format.parse(Integer.toString(hora.getMinute())).toString());
    }
    ...
    public void testarParserDataHora() {
        ...
        Assert.assertEquals(localDateTime, dataHora);
    }
    ...
    public void testarParserDataHoraBrasileira() {
        LocalDateTime localDateTime = DataUtil.parserDataHora(dataHoraStr.toString(), I18n.DATA_HORA_BRASILEIRA.getValor());
        Assert.assertEquals(localDateTime, dataHora);
    }
    ...
    public void testarParserHora() {
        LocalTime localTime = DataUtil.parserHora(horaStr.toString(), null); // TODO Verificar
        Assert.assertEquals(localTime, hora);
    }
